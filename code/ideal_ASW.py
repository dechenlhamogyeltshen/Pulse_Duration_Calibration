...
pd.DataFrame(transit_time_results).to_csv(os.path.join(out_path,"spheroidal_tt.csv"), index=False, header=False)
pd.DataFrame(arrival_speed_results).to_csv(os.path.join(out_path,"spheroidal_as.csv"), index=False, header=False)
